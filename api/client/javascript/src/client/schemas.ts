export interface paths {
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements': {
     ...
     */
    get: operations['listCustomerEntitlementsV2']
    put?: never
    /**
     ...
     *     Once an entitlement is created you cannot modify it, only delete it.
     */
    post: operations['createCustomerEntitlementV2']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}': {
     ...
     *     As access and status checks can be historical queries, deleting an entitlement populates the deletedAt timestamp. When queried for a time before that, the entitlement is still considered active, you cannot have retroactive changes to access, which is important for, among other things, auditing.
     */
    delete: operations['deleteCustomerEntitlementV2']
    options?: never
    head?: never
    patch?: never
    trace?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}/grants': {
     ...
     * @description List all grants issued for an entitlement. The entitlement can be defined either by its id or featureKey.
     */
    get: operations['listCustomerEntitlementGrantsV2']
    put?: never
    /**
     ...
     *     Grants cannot be changed once created, only deleted. This is to ensure that balance is deterministic regardless of when it is queried.
     */
    post: operations['createCustomerEntitlementGrantV2']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}/history': {
     ...
     *     WindowedHistory returns windowed usage data for the period enriched with balance information and the list of grants that were being burnt down in that window.
     */
    get: operations['getCustomerEntitlementHistoryV2']
    put?: never
    post?: never
    delete?: never
    options?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}/override': {
     ...
     *     This endpoint is useful for upgrades, downgrades, or other changes to entitlements that require a new entitlement to be created with zero downtime.
     */
    put: operations['overrideCustomerEntitlementV2']
    post?: never
    delete?: never
    options?: never
    head?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}/reset': {
     ...
     *     Usage is automatically reset for metered entitlements based on their usage period, but this endpoint allows to manually reset it at any time. When doing so the period anchor of the entitlement can be changed if needed.
     */
    post: operations['resetCustomerEntitlementUsageV2']
    delete?: never
    options?: never
    head?: never
    patch?: never
  ...
  '/api/v2/customers/{customerIdOrKey}/entitlements/{entitlementIdOrFeatureKey}/value': {
     ...
     * @description Checks customer access to a given feature (by key). All entitlement types share the hasAccess property in their value response, but multiple other properties are returned based on the entitlement type.
     */
    get: operations['getCustomerEntitlementValueV2']
    put?: never
    post?: never
    delete?: never
    options?: never
...
export type SubscriptionBadRequestErrorResponse =
...
export type SubscriptionErrorExtensions =
  components['schemas']['SubscriptionErrorExtensions']
...
export interface operations {
  ...
  overrideCustomerEntitlementV2: {
    parameters: {
      ...
      path: {
        customerIdOrKey: components['schemas']['ULIDOrExternalKey']
        entitlementIdOrFeatureKey: components['schemas']['ULIDOrExternalKey']
      }
      cookie?: never
    }
    requestBody: {
